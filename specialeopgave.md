...
Artificial Intelligence (AI) and Machine Learning (ML) have extended their reach far beyond the realm of technological innovation, now infiltrating diverse sectors of human activity. Of particular note is their permeation into academic research, which has seen a profound transformation through the application of these technologies. The inherent potential of AI and ML is immense, not only introducing innovative methods for inquiry but also opening up vistas for novel discoveries. One striking innovation is the Generative Pretrained Transformer 4 (GPT-4), an advanced Large Language Model (LLM) developed by OpenAI. This highly sophisticated language model offers a robust mechanism for processing and analysing substantial quantities of textual data, making it an invaluable asset in contemporary research.

The focus of this study lies in the exploration and application of GPT-4 in the sphere of qualitative research, more specifically, within the realm of organisational behaviour in IT departments. The setting for this study is the Vejle Municipality's IT department in Denmark. Despite a well-defined IT investment process in place, the department encounters challenges with regard to employee compliance. These issues have resulted in operational inefficiencies and inconsistencies, a concern that this research aims to delve into. The study's objective is to uncover the root causes behind such non-compliance, leveraging the power of GPT-4 to provide a deep, insightful understanding of the complexities involved. A unique aspect of our research lies in the use of GPT-4 to generate affinity diagrams. These visual representations of thematic connections capitalise on GPT-4's superior capacity to process, synthesise, and identify interconnected themes within voluminous text data.

The rapid evolution of digital technology continues to intersect with various dimensions of human existence, creating a seismic shift in traditional practices and establishing new paradigms. This transformative trend is especially evident in academia, where the advancements in AI and ML bring forth unprecedented possibilities. This study sets out to probe one such possibility—the integration of generative language models, represented here by GPT-4, into qualitative research methodologies.

This research navigates the landscape of Vejle municipality's IT department, a local government unit that provides essential services to a bustling community of over 120,000 residents [@vejlekommuneVejleKommuneRunder2022]. In spite of a robust IT investment process in place, the department grapples with discrepancies in employee compliance, leading to operational inefficiencies. Our research aims to unravel the reasons behind these discrepancies and formulate strategies that could enhance employee adherence.

We incorporate GPT-4 in this research in two distinct ways. Firstly, it is employed as an ancillary tool within traditional qualitative research to provide support and insights on demand, functioning as a round-the-clock academic aide. Secondly, we pioneer a more exploratory approach, harnessing the potential of this cutting-edge technology to expedite or enhance the qualitative analysis process. Our attempt here is to automate the creation of an affinity diagram from interview data with the goal of extrapolating new insights from the extensive dataset. For this, we deploy a bicameral dialogue approach, a technique that encourages the model's self-dialogue, simulating a two-sided conversation akin to a parliamentary discourse. However, despite the innovative bicameral dialogue approach, the resulting diagrams fell short of our anticipated expectations. Thus, we suggest further research to delve into the limitations and prospective applications of GPT-4 in the context of qualitative research.

By closely examining the interplay of technology and human behaviour, our study endeavours to provide solutions to Vejle Municipality's challenges, while concurrently illuminating new avenues for academic exploration. We contribute to understanding a specific socio-technical system within Vejle municipality, while also exploring the potential of LLMs as revolutionary instruments in academic research. Our investigation is situated at the thrilling intersection of technological innovation and human complexity, seeking to enrich both spheres with fresh insights and strategies.

GPT-4's exceptional capacity to process and generate insightful analyses from voluminous detailed text input has been capitalised upon in this study. With an ability to handle up to 8,000 tokens with the 8K model and an astounding 32,000 tokens with the 32K model, where each token represents approximately 0.75 words in English text [@openaiPricing], GPT-4 stands as a potent tool for data analysis.

Thus, this exploration serves a dual purpose. Firstly, it elucidates the socio-technical system within Vejle municipality and the specific dynamics influencing the IT investment process. Secondly, it uncovers the promise of AI and GPT-4 as trailblazing tools in academic research, providing an original perspective on qualitative studies. Consequently, our research is steered by two interconnected research questions:
...
2. What are the crucial factors contributing to the non-compliance of employees with the IT investment process in Vejle municipality, and how can these factors be addressed to bolster adherence?

These research questions seek to provide a comprehensive evaluation of GPT-4 as an innovative tool for qualitative research and simultaneously offer deeper insights into the dynamics of the IT investment process in Vejle municipality.
...
The insights accumulated serve as a solid foundation for further investigations. We now understand the mechanisms of the IT investment process in more depth, and we also recognize the potential of leveraging advanced technologies, such as artificial intelligence, to comprehend and bolster this process.

As we move forward into the next segment of our report, we will turn our attention to the applicability of GPT-4, a powerful artificial intelligence model, in the realm of qualitative research. We aim to investigate the capacity of GPT-4 to generate affinity diagrams, juxtaposing its performance with that of a human ethnographer. This undertaking introduces a thrilling intersection between qualitative research and artificial intelligence.

While these interim conclusions signify the end of this part of our report, they also usher in the intriguing discussions that lie ahead. The impending exploration of the role of AI, specifically GPT-4, in creating affinity diagrams, holds the promise of unveiling new perspectives and possibilities.
...
## Methodology
In this chapter, we depart from the traditional qualitative methods discussed in the previous chapter and pivot towards a more computational approach. Our methodology explores the intersection of artificial intelligence and ethnographic research, specifically utilising the Generative Pre-trained Transformer 4 (GPT-4) developed by OpenAI. This large language model (LLM) is deployed to conduct qualitative data analysis, particularly focusing on generating affinity diagrams from interview data.
...
In this section, we introduce the Chain of Thought Approach adapted for creating affinity diagrams using GPT-4. The primary purpose of this approach is to elicit more detailed and reasoned outputs from the model, thus achieving in-depth ethnographic analysis. We will discuss its application, design, challenges, and evaluation in the subsequent sections.
...
As one of the first forays into the intersection of large language models and qualitative research, this study emphasises the need for humanists to engage in discussions surrounding the future of research methods, AI integration, and the overarching implications of such technological advancements. The infancy of this field presents numerous opportunities for researchers to make transformative contributions, shaping the future of qualitative research practices in an increasingly AI-driven world.
# References
<div id="refs"></div>